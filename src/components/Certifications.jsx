  ...
  const certifications = [
    {
      ...
      date: '2026',
      icon: (
        <div className="flex items-center justify-center w-full h-[60px] filter drop-shadow-[0_0_15px_rgba(83,193,222,0.7)] group-hover:drop-shadow-[0_0_25px_rgba(83,193,222,0.95)] transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" width="70px" viewBox="0 0 32 32" fill="none" className="mx-auto">
